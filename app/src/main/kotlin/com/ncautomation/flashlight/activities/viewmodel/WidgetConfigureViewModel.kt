package com.ncautomation.flashlight.activities.viewmodel
...
internal class WidgetConfigureViewModel(
    ...
    init {
        ...
        if (_widgetColor.value == application.resources.getColor(R.color.default_widget_bg_color, null) && application.config.isUsingSystemTheme) {
            _widgetColor.value = application.resources.getColor(com.ncautomation.commons.R.color.you_primary_color, application.theme)
        }
